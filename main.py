...
# Bundle information together, hiding unecessary information, reusing code where possible, and using the same interface for different classes.
# Would it have been easier to implement a solution to this problem using a different coding style? Why or why not?
# No, python break down the code less and easier.
# How in particular did Object Oriented Programming assist in the solving of this problem?
# Make our code reusable and flexible.
# '''
